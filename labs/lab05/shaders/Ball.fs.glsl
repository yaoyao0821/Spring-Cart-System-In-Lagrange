...
vec3 shadedColour()
{
    ...
    vec3 materialDiffuseColour = materialColour;
    vec3 materialAmbientColour = vec3(0.6, 0.6, 0.6) * materialDiffuseColour;
    ...
    return materialAmbientColour + 
        ...
        cosTheta / (dist * dist) + 
        materialSpecularColour * lightColour * lightPower * pow(cosAlpha, 5) /
        (dist * dist);
}
